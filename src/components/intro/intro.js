...
const introData = {
  ...
  beforeName: "I'm ",
  name: "Nachiket",
  afterName: ", a passionate Software Developer, with a focus on backend systems, cloud and data-driven technologies.",
  contact: "Get in touch ",
  email: "nachiketerlekar@gmail.com",
  mailTo: "mailto:nachiketerlekar@gmail.com",
    ...
    <header className="intro">
      <div className="intro__content">
        ...
        <div className="intro__image">
          <img src={profileImage} alt="Nachiket Erlekar" className="profile-image" />
        </div>
      </div>
    </header>
  );
